                        ...
                        <div>
                            ...
                            <div className="mt-8 flex flex-wrap gap-3">
                                {[
                                    ...
                                    <span
                                        key={tag}
                                        className="rounded-full border border-zinc-200 bg-white/80 px-4 py-2 text-sm font-medium text-zinc-700 backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/80 dark:text-zinc-200"
                                    >
                                        {tag}
                                    </span>
                                ))}
